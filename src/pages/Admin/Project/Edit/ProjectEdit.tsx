...
import * as S from "./ProjectEdit.styles";
import { CustomInputsType, RoomTemplate, ROOM_TEMPLATES } from "settings";
import { Button } from "react-bootstrap";
import { EditProjectProps } from "./ProjectEdit.types";
...
const EditProject: React.FC<EditProjectProps> = ({
  ...
  const renderDescriptionInput = () => (
    <S.InputWrapper>
      <span>The project description</span>
      <input
        type="text"
        ref={register}
        name="description"
  ...
  const renderLogoInput = () => (
    <S.InputWrapper>
      <span>How you want your project to appear on the map</span>
